...
<?php
  ...
  $sql = show_sql('tb_siswa',null,null,'id_siswa',$_GET['id']);
  $result = mysqli_query($kon,$sql);
  $row = mysqli_fetch_array($result);
 ?>
 <ol class="breadcrumb">
  <li><a href="?page=home">Home</a></li>
  <li><a href="?page=datasiswa">Data Siswa</a></li>
  <li class="active">Edit Siswa</li>
</ol>
<div class="panel panel-primary" style="margin-top:20px; width: 100%">
  <div class="panel-heading"><h2 style="margin:10px">Edit Siswa</h2></div> <br>
<div class="container" style="width: 100%">
  <form class="form-horizontal" action="system/edit.php" method="POST">
      ...
      <div class="col-sm-10">
        <input type="pendaftaran" class="form-control" id="" name="nis" readonly required="required" value="<?php echo $row['nis'] ?>">
      </div>
   </div>
    ...
    <input type="hidden" name="old_id" value="<?php echo $row['nis'] ?>">
</form>
</div>
</div>
</body>